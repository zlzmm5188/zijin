...
async function loadInviteInfo() {
    try {
        ...
        // 1. 调用邀请信息API
        const inviteResponse = await apiRequest('/index.php/user/user/invite', {}, 'GET');
        ...
        // 2. 获取奖励规则
        try {
            const rewardsResponse = await apiRequest('/index.php/user/invite/rewards_config', {}, 'GET');
...
function renderRewards() {
    ...
    // 从invite接口获取佣金比例
    apiRequest('/index.php/user/user/invite', {}, 'GET').then(data => {
        if (data.data) {
